...
if [ ! -d "../Part/bin/$APP.app" ]; then
    echo ${red} "Can't find Part/bin/$APP.app. Package your AIR app!" ${white}
    exit 72
fi
...
if [ ! -f "Part-icon-1024.png" ]; then
    echo ${red} "Can't find Part-icon-1024.png. Create a 1024x1024 png." ${white}
    exit
fi

sips -z 16 16     Part-icon-1024.png --out PartAppIcon.iconset/icon_16x16.png > /dev/null 2>&1
sips -z 32 32     Part-icon-1024.png --out PartAppIcon.iconset/icon_16x16@2x.png > /dev/null 2>&1
sips -z 32 32     Part-icon-1024.png --out PartAppIcon.iconset/icon_32x32.png > /dev/null 2>&1
sips -z 64 64     Part-icon-1024.png --out PartAppIcon.iconset/icon_32x32@2x.png > /dev/null 2>&1
sips -z 128 128   Part-icon-1024.png --out PartAppIcon.iconset/icon_128x128.png > /dev/null 2>&1
sips -z 256 256   Part-icon-1024.png --out PartAppIcon.iconset/icon_128x128@2x.png > /dev/null 2>&1
sips -z 256 256   Part-icon-1024.png --out PartAppIcon.iconset/icon_256x256.png > /dev/null 2>&1
sips -z 512 512   Part-icon-1024.png --out PartAppIcon.iconset/icon_256x256@2x.png > /dev/null 2>&1
sips -z 512 512   Part-icon-1024.png --out PartAppIcon.iconset/icon_512x512.png > /dev/null 2>&1
cp Part-icon-1024.png PartAppIcon.iconset/icon_512x512@2x.png
xcrun iconutil -c icns PartAppIcon.iconset
cp -R "PartAppIcon.icns" "$APP.app/Contents/Resources/Icon.icns"
cp -R "PartAssets.car" "$APP.app/Contents/Resources/Assets.car"
