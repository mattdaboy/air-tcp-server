...
public class SocketManagerConst {
    ...
    public static var TCP_SERVER_ADDRESS:String = "127.0.0.1";
    ...
    public static const ASK_DECONNECTION_FROM_WEB_SOCKET:String = "ASK_DECONNECTION_FROM_WEB_SOCKET";

    // max utilisateurs : on compte aussi le formateur donc 3 correspond à 1 animateur et 2 participants
    public static const MAX_USERS:Number = 3;
    ...
    // ping pong avec le participant
    public static const ARE_YOU_THERE:String = "ARE_YOU_THERE";
    public static const IM_THERE:String = "IM_THERE";
    public static const SLOW_CONNECTION:String = "SLOW_CONNECTION";
    public static const MEDIUM_CONNECTION:String = "MEDIUM_CONNECTION";
    public static const HIGH_CONNECTION:String = "HIGH_CONNECTION";
    public static const USER_TIMEOUT:String = "USER_TIMEOUT";
    public static const INIT_CONNECTION:String = "INIT_CONNECTION";
    ...
    // Timer
    public static const LAUNCH_OPENDO_TIMER:String = "LAUNCH_OPENDO_TIMER";
    public static const CLOSE_OPENDO_TIMER:String = "CLOSE_OPENDO_TIMER";
    public static const PAUSE_OPENDO_TIMER:String = "PAUSE_OPENDO_TIMER";
    public static const RESUME_OPENDO_TIMER:String = "RESUME_OPENDO_TIMER";
    ...
    // params de session
    public static const SESSION_PARAMS:String = "SESSION_PARAMS";
    public static const SESSION_PARAMS_NEED_DATA:String = "SESSION_PARAMS_NEED_DATA";
    public static const SESSION_PARAMS_DATA:String = "SESSION_PARAMS_DATA";
}
}