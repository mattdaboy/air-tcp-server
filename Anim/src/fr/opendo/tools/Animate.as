...
public class Animate {
    private static var _xstart:Number;
    private static var _ystart:Number;
    ...
    public function Animate() {
        throw new Error("!!! Animate est un singleton et ne peut pas être instancié !!!");
    }

    public static function modalIn(view:DisplayObjectContainer):void {
        var view_converted:MovieClip = MovieClip(view);

        _xstart = -((1920 * Const.POPUP_SCALE) - 1920) / 2;
        _ystart = -((1200 * Const.POPUP_SCALE) - 1200) / 2;
        ...
        TweenLite.to(view_converted, Const.ANIM_DURATION, {alpha: 1, x: 0, y: 0, scaleX: 1, scaleY: 1, ease: Power2.easeOut});
    }
    ...
    public static function modalOut(view:DisplayObjectContainer, func:Function = null, ...args):void {
        ...
        TweenLite.to(view_converted, Const.ANIM_DURATION, {alpha: 0, x: _xstart, y: _ystart, scaleX: Const.POPUP_SCALE, scaleY: Const.POPUP_SCALE, ease: Power2.easeIn, onComplete: complete});
    }
    ...
    public static function editorIn(view:DisplayObjectContainer):void {
        ...
        TweenLite.to(view_converted, Const.ANIM_DURATION, {alpha: 1, x: 0, ease: Power2.easeOut});
    }
    ...
    public static function editorOut(view:DisplayObjectContainer, func:Function = null, ...args):void {
        ...
        TweenLite.to(view_converted, Const.ANIM_DURATION, {alpha: 0, x: DECAL, ease: Power2.easeIn, onComplete: complete});
    }
