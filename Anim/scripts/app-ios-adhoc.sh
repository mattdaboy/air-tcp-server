...
echo ${cyn}"Packaging opendo-anim.ipa (Ad Hoc)"${white}
...
then
echo ${mag}"Packaging opendo-anim.ipa (Ad Hoc) : Done !"${white}
echo ""
else
echo ${red}"Packaging opendo-anim.ipa (Ad Hoc) : Failed :/"${white}
echo ""
fi
