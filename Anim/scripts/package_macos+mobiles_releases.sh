...
echo ${mag}"Package macOS + mobiles releases + Sign operations"${white}
...
then
echo ${mag}"Package macOS + mobiles releases + Sign operations : Done :)"
echo ${cyn}""
echo ${cyn}"          ***************                                                                                                       **,                   "
echo ${cyn}"      *,, ******************                                                                                                    **,                   "
echo ${cyn}"    ***  *********************,                                                                                                 **,                   "
...
echo ${red}"Package macOS + mobiles releases + Sign operations : Failed :/"${white}
echo ""
fi
