...
echo ${cyn}"Building opendo-anim-auto-update.swf"${white}
...
then
echo ${mag}"Building opendo-anim-auto-update.swf : Done !"${white}
echo ""
else
echo ${red}"Building opendo-anim-auto-update.swf : Failed :/"${white}
echo ""
fi
