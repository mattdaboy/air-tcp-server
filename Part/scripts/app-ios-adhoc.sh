...
echo ${cyn}"Packaging opendo-part.ipa (Ad Hoc)"${white}
...
../cert/Opendo_wildcard_distribution__exp_2024_04_05.mobileprovision \
bin/opendo-part.ipa \
app-ios.xml \
-extdir \
lib \
...
then
echo ${mag}"Packaging opendo-part.ipa (Ad Hoc) : Done !"${white}
echo ""
else
echo ${red}"Packaging opendo-part.ipa (Ad Hoc) : Failed :/"${white}
echo ""
fi
